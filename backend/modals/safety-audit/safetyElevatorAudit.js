...
const safetyElevatorAuditSchema = new mongoose.Schema(
  {
    facility_id: {
...
safetyElevatorAuditSchema.plugin(softDeletePlugin);

safetyElevatorAuditSchema.index({
  facility_id: 1,
