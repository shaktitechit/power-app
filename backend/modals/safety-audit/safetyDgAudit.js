...
const safetyDgAuditSchema = new mongoose.Schema(
  {
    facility_id: {
...
safetyDgAuditSchema.plugin(softDeletePlugin);

safetyDgAuditSchema.index({
  facility_id: 1,
...
export default mongoose.model("SafetyDgAudit", safetyDgAuditSchema);