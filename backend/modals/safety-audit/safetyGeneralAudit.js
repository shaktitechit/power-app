...
const safetyGeneralAuditSchema = new mongoose.Schema(
  {
    facility_id: {
...
safetyGeneralAuditSchema.plugin(softDeletePlugin);

safetyGeneralAuditSchema.index({
  facility_id: 1,
