...
export function ACAuditRecordSection({
  ...
  const [deleteTarget, setDeleteTarget] = useState<ACAuditFormState | null>(null);
  ...
  const handleDelete = (form: ACAuditFormState) => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      await toastHandler({
        action: () => deleteACAuditRecord(deleteTarget.id as string).unwrap(),
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. It will permanently delete this AC audit record.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
