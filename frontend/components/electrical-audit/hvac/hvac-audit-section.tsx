...
export function HVACAuditSection({
  ...
  const [deleteTarget, setDeleteTarget] = useState<HVACAuditFormState | null>(null);
  ...
  const handleDelete = (form: HVACAuditFormState) => {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      await toastHandler({
        action: () => deleteHVACAudit(deleteTarget.id as string).unwrap(),
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. It will permanently delete this HVAC audit record.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
